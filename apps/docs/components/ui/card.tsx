...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center border-t border-foreground/5 pt-3", className)}
      {...props}
    />
  );
}

export { Card, Cards, CardHeader, CardFooter, CardTitle, CardAction, CardDescription, CardContent };
