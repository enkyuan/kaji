...
export function CursorLogo({ size = 16, color, className }: IconProps) {
  return (
    <svg
...
export function ClaudeCodeLogo({ size = 16, color, className }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 16 16"
...
export function OpenCodeLogo({ size = 16, color, className }: IconProps) {
  return (
    <svg
      viewBox="0 0 32 40"
      fill="none"
